...
class EvaluasiFstRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'saran_pii_batam'                 => 'nullable|string',
            'saran_ika_fst'                   => 'nullable|string',
            'saran_prodi_teknik_industri'     => 'nullable|string',
            'saran_prodi_if_si'               => 'nullable|string',
            'saran_prodi_logistik_perkapalan' => 'nullable|string',
            'saran_laboratorium'              => 'nullable|string',
            'saran_hima_fst'                  => 'nullable|string',
