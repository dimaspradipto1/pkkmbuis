...
class EvaluasiPelayananKemahasiswaanPusatPrestasiRequest extends FormRequest
{
    /**
    ...
    {
        $questions = \App\Models\EvaluasiPelayananKemahasiswaanPusatPrestasi::questions();
        $rules = [];
