...
class SoalPretestKeempatDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($item) {
                ...
                return '
                    <div class="d-flex justify-content-center gap-1">
                        <a href="' . route('soalpretestkeempat.edit', $item->id) . '" class="btn btn-sm btn-warning text-white px-3 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form action="' . route('soalpretestkeempat.destroy', $item->id) . '" method="POST" style="display: inline">
                            ' . csrf_field() . '
                            ' . method_field('DELETE') . '
    ...
    public function query(SoalPretestKeempat $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('soalpretestkeempat-table')
    ...
    {
        return 'SoalPretestKeempat_' . date('YmdHis');
    }
}
