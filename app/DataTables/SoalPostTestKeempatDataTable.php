...
class SoalPostTestKeempatDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($item) {
                ...
                return '
                    <div class="d-flex justify-content-center gap-1">
                        <a href="' . route('soalposttestkeempat.edit', $item->id) . '" class="btn btn-sm btn-warning text-white px-3 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form action="' . route('soalposttestkeempat.destroy', $item->id) . '" method="POST" style="display:inline">
    ...
    public function query(SoalPostTestKeempat $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('soalposttestkeempat-table')
    ...
    {
        return 'SoalPostTestKeempat_' . date('YmdHis');
    }
}
