...
class SoalPostTestKetigaDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($item) {
                ...
                return '
                    <div class="d-flex justify-content-center gap-1">
                        <a href="' . route('soalposttestketiga.edit', $item->id) . '" class="btn btn-sm btn-warning text-white px-3 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form action="' . route('soalposttestketiga.destroy', $item->id) . '" method="POST" style="display:inline">
    ...
    public function query(SoalPostTestKetiga $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('soalposttestketiga-table')
    ...
    {
        return 'SoalPostTestKetiga_' . date('YmdHis');
    }
}
