...
class RekapNilaiAkhirDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('total_akhir', function ($row) {
                ...
                $total = ($scoreTes * 0.1) + ($scoreTugas * 0.1) + ($scoreAbs * 0.5) + ($scoreDis * 0.3);
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(6, 'desc') // Change to DESC to see highest scores first
            ->selectStyleSingle()
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('score_tes')->title('TEST (10%)')->addClass('text-center'),
            Column::computed('score_tugas')->title('TUGAS (10%)')->addClass('text-center'),
