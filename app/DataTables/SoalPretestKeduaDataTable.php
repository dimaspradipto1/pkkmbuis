...
class SoalPretestKeduaDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($item) {
                ...
                return '
                    <div class="d-flex justify-content-center gap-1">
                        <a href="' . route('soalpretestkedua.edit', $item->id) . '" class="btn btn-sm btn-warning text-white px-3 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form action="' . route('soalpretestkedua.destroy', $item->id) . '" method="POST" style="display: inline">
                            ' . csrf_field() . '
                            ' . method_field('DELETE') . '
    ...
    public function query(SoalPretestKedua $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('soalpretestkedua-table')
    ...
    {
        return 'SoalPretestKedua_' . date('YmdHis');
    }
}
