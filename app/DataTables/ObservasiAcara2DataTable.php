...
class ObservasiAcara2DataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<ObservasiAcara2> $query Results from query() method.
     */
            ...
            ->addColumn('action', function ($item) {
                return '
                    <div class="d-flex justify-content-center gap-1">
                        <a href="' . route('observasiacara2.edit', $item->id) . '" class="btn btn-sm btn-warning text-white px-3 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                        <form action="' . route('observasiacara2.destroy', $item->id) . '" method="POST" style="display: inline">
                            ' . csrf_field() . '
                            ' . method_field('DELETE') . '
     ...
     *
     * @return QueryBuilder<ObservasiAcara2>
     */
    public function query(ObservasiAcara2 $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('observasiacara2-table')
    ...
    {
        return 'ObservasiAcara2_' . date('YmdHis');
    }
}
