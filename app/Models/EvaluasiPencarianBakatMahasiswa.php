...
class EvaluasiPencarianBakatMahasiswa extends Model
{
    use HasFactory;

    protected $table = 'evaluasi_pencarian_bakat_mahasiswas';
    ...
    public static function questions(): array
    {
        ...
        return EvaluasiQuestion::getQuestionsForMenu(12, $defaults);
    }
}
