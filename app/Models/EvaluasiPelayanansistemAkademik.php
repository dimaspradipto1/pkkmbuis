...
class EvaluasiPelayanansistemAkademik extends Model
{
    use HasFactory;

    protected $table = 'evaluasi_pelayanansistem_akademiks';
    ...
    public static function questions(): array
    {
        ...
        return EvaluasiQuestion::getQuestionsForMenu(3, $defaults);
    }
}
