...
class EvbvaluasiPendidikanTinggidiEraDigitaldanRevolusiIndustri extends Model
{
    use HasFactory;

    protected $table = 'evaluasi_era_digital_revolusi_industris';
    ...
    public static function questions(): array
    {
        ...
        return EvaluasiQuestion::getQuestionsForMenu(7, $defaults);
    }
}
