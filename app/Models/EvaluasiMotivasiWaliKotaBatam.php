...
class EvaluasiMotivasiWaliKotaBatam extends Model
{
    use HasFactory;

    protected $table = 'evaluasi_motivasi_wali_kota_batams';
    ...
    public static function questions(): array
    {
        ...
        return EvaluasiQuestion::getQuestionsForMenu(13, $defaults);
    }
}
