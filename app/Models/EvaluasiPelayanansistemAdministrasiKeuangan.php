...
class EvaluasiPelayanansistemAdministrasiKeuangan extends Model
{
    use HasFactory;

    protected $table = 'evaluasi_pelayanansistem_administrasi_keuangans';
    ...
    public static function questions(): array
    {
        ...
        return EvaluasiQuestion::getQuestionsForMenu(4, $defaults);
    }
}
