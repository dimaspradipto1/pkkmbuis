...
class EvaluasiMotivasiGubernurKepulauanRiau extends Model
{
    use HasFactory;

    protected $table = 'evaluasi_motivasi_gubernur_kepulauan_riaus';
    ...
    public static function questions(): array
    {
        ...
        return EvaluasiQuestion::getQuestionsForMenu(14, $defaults);
    }
}
