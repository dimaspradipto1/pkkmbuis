        ...
        <div class="login-form-box">
            ...
            <form action="{{ route('login.post') }}" method="POST">
                ...
                <div class="form-group-custom">
                    <label class="form-label-custom">NIM / NUP / ID PENDAFTAR / EMAIL / NO. WHATSAPP</label>
                    ...
                    <div class="form-hint mt-1" style="font-size: 0.72rem; color: #64748b;">
                        <i class="bi bi-info-circle text-success me-1"></i>Bisa berupa <strong>NIM</strong>, <strong>NUP</strong>, <strong>ID Pendaftar</strong>, <strong>No. WA (628...)</strong>, atau <strong>Email</strong>
                    </div>
                </div>
