    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Observasi Acara 2</h5>

                        <form action="{{ route('observasiacara2.update', $observasiAcara2->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="waktu_runddown" id="waktu_runddown" class="form-control" value="{{ old('waktu_runddown', $observasiAcara2->waktu_runddown) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="waktu_realisasi" id="waktu_realisasi" class="form-control" value="{{ old('waktu_realisasi', $observasiAcara2->waktu_realisasi) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="kegiatan" id="kegiatan" class="form-control" rows="3" required>{{ old('kegiatan', $observasiAcara2->kegiatan) }}</textarea>
                                </div>
                            </div>
                            ...
                            @php
                                ...
                                if (!$aspekItems) {
                                    $aspekItems = collect(explode("\n", (string) $observasiAcara2->aspek_observasi))
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <div class="form-check form-check-inline me-4">
                                            <input class="form-check-input" type="radio" name="skala" id="skala_{{ $i }}" value="{{ $i }}" {{ old('skala', $observasiAcara2->skala) == $i ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="catatan" id="catatan" class="form-control" rows="3">{{ old('catatan', $observasiAcara2->catatan) }}</textarea>
                                </div>
                            </div>
                            ...
                            @php
                                ...
                                if (!$linkItems) {
                                    $linkItems = collect(explode("\n", (string) $observasiAcara2->link_dokumen))
