                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kedisiplinanpertama.update', $kedisiplinanPertama->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kelengkapan_atribut" id="atribut_lengkap" value="Lengkap" {{ old('kelengkapan_atribut', $kedisiplinanPertama->kelengkapan_atribut) == 'Lengkap' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="atribut_lengkap">Lengkap</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kelengkapan_atribut" id="atribut_tidak_lengkap" value="Tidak Lengkap" {{ old('kelengkapan_atribut', $kedisiplinanPertama->kelengkapan_atribut) == 'Tidak Lengkap' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ketepatan_waktu" id="waktu_tepat" value="Tepat Waktu" {{ old('ketepatan_waktu', $kedisiplinanPertama->ketepatan_waktu) == 'Tepat Waktu' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="waktu_tepat">Tepat Waktu</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ketepatan_waktu" id="waktu_terlambat" value="Terlambat" {{ old('ketepatan_waktu', $kedisiplinanPertama->ketepatan_waktu) == 'Terlambat' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="perilaku" id="perilaku_baik" value="Baik" {{ old('perilaku', $kedisiplinanPertama->perilaku) == 'Baik' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="perilaku_baik">Baik</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="perilaku" id="perilaku_tidak_baik" value="Tidak Baik" {{ old('perilaku', $kedisiplinanPertama->perilaku) == 'Tidak Baik' ? 'checked' : '' }}>
