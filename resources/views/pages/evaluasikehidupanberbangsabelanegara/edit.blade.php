...
<div class="pagetitle">
    <h1>Edit Evaluasi Kehidupan Berbangsa, Bernegara dan Pembinaan Kesadaran Bela Negara</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasikehidupanberbangsabelanegara.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
