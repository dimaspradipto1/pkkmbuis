...
<div class="pagetitle">
    <h1>Isi Evaluasi Kehidupan Berbangsa, Bernegara dan Pembinaan Kesadaran Bela Negara</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasikehidupanberbangsabelanegara.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-top-card">
                ...
                <div class="eval-top-body">
                    <h2 class="eval-top-title">
                        ...
                        (Materi Kehidupan Berbangsa, Bernegara dan pembinaan kesadaran bela negara)
                    </h2>
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasikehidupanberbangsabelanegara.index') }}" class="btn btn-outline-secondary px-4 me-2">
                            Kembali
                        </a>
                    @endif
