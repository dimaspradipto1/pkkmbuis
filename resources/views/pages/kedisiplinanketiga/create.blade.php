...
@section('content')
    <div class="pagetitle">
        <h1>Tambah Penilaian Kedisiplinan Hari III</h1>
        <nav>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('kedisiplinanketiga.store') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div id="already-exists-alert" class="alert alert-warning py-2 px-3 mt-2" style="display: none; border-radius: 8px;">
                                        <i class="fa-solid fa-triangle-exclamation me-1"></i> <strong>Perhatian:</strong> Pengguna ini sudah memiliki data kedisiplinan Hari III. Menyimpan form ini akan <strong>memperbarui (update)</strong> data tersebut.
                                    </div>
                                </div>
                            </div>
