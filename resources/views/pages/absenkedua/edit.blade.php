                            ...
                            <div class="row mb-3" id="container_catatan" style="display: none;">
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="catatan_datang" id="catatan_datang" class="form-control" rows="2" placeholder="Masukkan catatan/keterangan saat Hadir Datang (misal: Datang Terlambat)...">{{ old('catatan_datang', $absenKedua->catatan_datang ?? '') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="catatan_pulang" class="form-label fw-semibold text-secondary small">Catatan Waktu Pulang (Opsional)</label>
                                        <textarea name="catatan_pulang" id="catatan_pulang" class="form-control" rows="2" placeholder="Masukkan catatan/keterangan saat Hadir Pulang (misal: Izin Pulang Awal)...">{{ old('catatan_pulang', $absenKedua->catatan_pulang ?? '') }}</textarea>
                                    </div>
