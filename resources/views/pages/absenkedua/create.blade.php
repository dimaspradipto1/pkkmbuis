            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('absenkedua.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#user_id').on('change', function() {
                ...
                $.get("{{ url('absenkedua/check-status') }}/" + userId, function(res) {
                    if (res.is_complete) {
                        if (typeof Swal !== 'undefined') {
                            Swal.fire({
                                icon: 'warning',
                                title: 'Peringatan',
                                text: 'Pengguna ini sudah memiliki data absensi kedua lengkap (Pagi & Sore)!',
                                confirmButtonColor: '#3085d6'
                            });
                        } else {
                            alert('Pengguna ini sudah memiliki data absensi kedua lengkap (Pagi & Sore)!');
                        }
