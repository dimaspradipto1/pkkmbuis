...
<div class="pagetitle">
    <h1>Edit Evaluasi FST (Fakultas Sains dan Teknologi)</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasifst.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
            ...
            <div class="eval-action-bar">
                <div>
                    <a href="{{ route('evaluasifst.index') }}" class="btn btn-outline-secondary px-4 me-2">Batal</a>
                    <button type="submit" class="btn text-white px-4" style="background-color: #9F1521; border-color: #9F1521;">Update Evaluasi</button>
                </div>
            </div>
        </form>
    </div>
