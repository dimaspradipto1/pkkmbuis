...
<style>
    ...
    .eval-header-card { background-color: #9F1521 !important; color: #ffffff; border-radius: 10px 10px 0 0; padding: 16px 24px; font-weight: 700; font-size: 1.1rem; border-top: 4px solid #FFC107; }
    ...
    .score-badge { font-size: 1.1rem; font-weight: 700; padding: 6px 16px; border-radius: 20px; background-color: #9F1521 !important; color: #fff; }
</style>

<div class="pagetitle">
    <h1>Detail Evaluasi FST (Fakultas Sains dan Teknologi)</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        <div class="eval-header-card">DETAIL EVALUASI FST (FAKULTAS SAINS DAN TEKNOLOGI)</div>
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasifst.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            @if(Auth::user()->role != 'mahasiswa')
                <a href="{{ route('evaluasifst.edit', $evaluasi->id) }}" class="btn text-white px-4" style="background-color: #9F1521;">
