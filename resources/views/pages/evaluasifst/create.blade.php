...
<div class="pagetitle">
    <h1>Isi Evaluasi FST (Fakultas Sains dan Teknologi)</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasifst.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasifst.index') }}" class="btn btn-outline-secondary px-4 me-2">Kembali</a>
                    @endif
                    <button type="submit" class="btn text-white px-4" style="background-color: #9F1521; border-color: #9F1521;">
                        Simpan Evaluasi
                    </button>
                </div>
                <div>
