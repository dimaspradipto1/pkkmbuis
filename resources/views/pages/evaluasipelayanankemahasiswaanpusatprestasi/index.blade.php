...
@section('content')
    <div class="pagetitle d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            @endif
            <a href="{{ route('evaluasi.export', 2) }}" class="btn btn-success btn-sm shadow-sm rounded-pill px-3 py-2">
        ...
        $(document).ready(function() {
            ...
            $('#btn-bulk-delete').click(function() {
                ...
                const doDelete = function() {
                    const form = $('<form>', {
                        action: "{{ route('evaluasipelayanankemahasiswaanpusatprestasi.bulk-delete') }}",
                        method: 'POST'
                    });
                    form.append('@csrf');
