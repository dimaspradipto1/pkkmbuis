...
<style>
    ...
    .eval-header-card { background-color: #F5A524 !important; color: #ffffff; border-radius: 10px 10px 0 0; padding: 16px 24px; font-weight: 700; font-size: 1.1rem; }
    ...
    .score-badge { font-size: 1.1rem; font-weight: 700; padding: 6px 16px; border-radius: 20px; background-color: #F5A524 !important; color: #fff; }
</style>

<div class="pagetitle">
    <h1>Detail Evaluasi FEB (Fakultas Ekonomi dan Bisnis)</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        <div class="eval-header-card">DETAIL EVALUASI FEB (FAKULTAS EKONOMI DAN BISNIS)</div>
        <div class="eval-header-body">
            <div class="row">
                ...
                <div class="col-md-6 text-md-end mt-3 mt-md-0">
                    ...
                    <span class="badge score-badge">{{ $avg }} / 4</span>
                </div>
            </div>
        </div>
            ...
            @if(in_array($key, ['q1','q2','q3','q4','q5','q6','q7','q8']))
                <div class="eval-card" style="{{ $loop->last ? 'border-radius:0 0 10px 10px; margin-bottom:24px;' : 'border-radius:0;' }}">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge text-white px-3 py-2" style="background-color: #F5A524; font-size: 0.95rem;">Skala: {{ $evaluasi->$key }} / 4</span>
                    </div>
                </div>
            @endif
        @endforeach
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasifeb.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            @if(Auth::user()->role != 'mahasiswa')
                <a href="{{ route('evaluasifeb.edit', $evaluasi->id) }}" class="btn text-white px-4" style="background-color: #F5A524;">
