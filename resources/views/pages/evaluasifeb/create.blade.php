...
<div class="pagetitle">
    <h1>Isi Evaluasi FEB (Fakultas Ekonomi dan Bisnis)</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasifeb.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasifeb.index') }}" class="btn btn-outline-secondary px-4 me-2">Kembali</a>
                    @endif
                    <button type="submit" class="btn text-white px-4" style="background-color: #F5A524; border-color: #F5A524;">
                        Simpan Evaluasi
                    </button>
                </div>
                <div>
