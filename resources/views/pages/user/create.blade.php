                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nim" class="form-control" id="nim" value="{{ old('nim') }}" placeholder="Opsional / jika sudah ada">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nup" class="form-control" id="nup" value="{{ old('nup') }}" placeholder="Opsional / jika sudah ada">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="no_wa" class="form-control" id="no_wa" value="{{ old('no_wa') }}" placeholder="Contoh: 6281234567890">
