                            ...
                            <div class="row mb-3" id="container_catatan" style="display: none;">
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3" id="wrapper_catatan_datang" style="display: none;">
                                        ...
                                        <textarea name="catatan_datang" id="catatan_datang" class="form-control" rows="2" placeholder="Masukkan catatan/keterangan saat Hadir Datang (misal: Datang Terlambat)...">{{ old('catatan_datang', $absenKetiga->catatan_datang ?? '') }}</textarea>
                                    </div>
                                    <div class="mb-3" id="wrapper_catatan_pulang" style="display: none;">
                                        ...
                                        <textarea name="catatan_pulang" id="catatan_pulang" class="form-control" rows="2" placeholder="Masukkan catatan/keterangan saat Hadir Pulang (misal: Izin Pulang Awal)...">{{ old('catatan_pulang', $absenKetiga->catatan_pulang ?? '') }}</textarea>
                                    </div>
                                    <div id="wrapper_bukti_izin">
                                        ...
                                        <div id="preview_container" class="mt-3"
                                            style="{{ !empty($absenKetiga->bukti_izin) ? '' : 'display: none;' }}">
                                            <small class="text-muted fw-semibold d-block mb-1">Preview Bukti:</small>
                                            <a id="preview_link"
                                                href="{{ !empty($absenKetiga->bukti_izin) ? asset('storage/' . $absenKetiga->bukti_izin) : '#' }}"
                                                target="_blank">
                                                <img id="image_preview"
                                                    src="{{ !empty($absenKetiga->bukti_izin) ? asset('storage/' . $absenKetiga->bukti_izin) : '' }}"
