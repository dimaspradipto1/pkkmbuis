            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('absenketiga.update', $absenKetiga->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="hadir_pagi" id="hadir_pagi" class="form-select">
                                        ...
                                        <option value="Hadir" {{ (old('hadir_pagi', $absenKetiga->hadir_pagi) == 'Hadir') ? 'selected' : '' }}>Hadir</option>
                                        <option value="Izin" {{ (old('hadir_pagi', $absenKetiga->hadir_pagi) == 'Izin') ? 'selected' : '' }}>Izin</option>
                                        <option value="Tidak Hadir" {{ (old('hadir_pagi', $absenKetiga->hadir_pagi) == 'Tidak Hadir') ? 'selected' : '' }}>Tidak Hadir</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="hadir_sore" id="hadir_sore" class="form-select">
                                        ...
                                        <option value="Hadir" {{ (old('hadir_sore', $absenKetiga->hadir_sore) == 'Hadir') ? 'selected' : '' }}>Hadir</option>
                                        <option value="Izin" {{ (old('hadir_sore', $absenKetiga->hadir_sore) == 'Izin') ? 'selected' : '' }}>Izin</option>
                                        <option value="Tidak Hadir" {{ (old('hadir_sore', $absenKetiga->hadir_sore) == 'Tidak Hadir') ? 'selected' : '' }}>Tidak Hadir</option>
                                    </select>
                                </div>
                            </div>
