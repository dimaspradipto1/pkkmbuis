...
@section('content')
    <div class="pagetitle">
        <h1>Data Absensi Ketiga</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item">Absensi Ketiga</li>
            </ol>
        </nav>
    </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                @if (Auth::user()->role != 'mahasiswa')
                                    <button type="button" class="btn btn-outline-dark" onclick="showSessionQR('Hadir Pagi (Hari III)', 'ABSEN_3_PAGI')">
                                        <i class="bi bi-qr-code me-1"></i> QR Pagi
                                    </button>
                                    <button type="button" class="btn btn-outline-dark" onclick="showSessionQR('Hadir Sore (Hari III)', 'ABSEN_3_SORE')">
