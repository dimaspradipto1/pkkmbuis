    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                @if (Auth::user()->role != 'mahasiswa')
                                    ...
                                    <a href="{{ route('absenketiga.export') }}" class="btn btn-success text-white">
                                ...
                                @else
                                    @if ($isVisible && $isActive)
                                        <a href="{{ route('absenketiga-scan.index') }}" class="btn btn-success">
                ...
                @include('partials.absen-notes', ['category' => 'absenketiga'])
        ...
        $(document).ready(function() {
            ...
            $('#btn-bulk-delete').click(function() {
                ...
                const doDelete = function() {
                    const form = $('<form>', {
                        action: "{{ route('absenketiga.bulk-delete') }}",
                        method: 'POST'
                    });
                    form.append('@csrf');
