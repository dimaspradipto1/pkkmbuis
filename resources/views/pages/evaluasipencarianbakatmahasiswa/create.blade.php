...
<style>
    ...
    @media (max-width: 576px) {
        .eval-top-body { padding: 16px 16px; }
...
<div class="pagetitle">
    <h1>Isi Evaluasi Pencarian Bakat Mahasiswa</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasipencarianbakatmahasiswa.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-top-card">
                ...
                <div class="eval-top-body">
                    <h2 class="eval-top-title">
                        ...
                        (Pencarian Bakat Mahasiswa UIS (Survei minat UKM) dan Sosialiasi BEI)
                    </h2>
            ...
            <div class="eval-header-body">
                <p class="mb-1 text-secondary" style="font-size: 0.95rem;">
                    Berikan tanggapan Anda terhadap keseluruhan Pemateri dan Materi yang disajikan.
                </p>
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasipencarianbakatmahasiswa.index') }}" class="btn btn-outline-secondary px-4 me-2">
                            Kembali
                        </a>
                    @endif
                ...
                <div>
                    <button type="reset" class="btn btn-link text-decoration-none text-muted p-0">
                        Kosongkan formulir
                    </button>
                </div>
            </div>
