...
<div class="pagetitle">
    <h1>Detail Evaluasi Motivasi Wali Kota Batam</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        <div class="eval-header-card">DETAIL EVALUASI MOTIVASI WALI KOTA BATAM</div>
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasimotivasiwalikotabatam.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            @if(Auth::user()->role != 'mahasiswa')
                <a href="{{ route('evaluasimotivasiwalikotabatam.edit', $evaluasi->id) }}" class="btn btn-primary px-4">
