...
<div class="pagetitle">
    <h1>Isi Evaluasi Motivasi Wali Kota Batam</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasimotivasiwalikotabatam.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasimotivasiwalikotabatam.index') }}" class="btn btn-outline-secondary px-4 me-2">Kembali</a>
                    @endif
