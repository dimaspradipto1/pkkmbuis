...
@section('content')
    <div class="pagetitle">
        <h1>Observasi Acara Fikes</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item">Observasi Acara Fikes</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title">List Observasi Acara Fikes</h5>
                            <a href="{{ route('observasiacarafikes.create') }}" class="btn btn-primary btn-sm shadow-sm px-3 text-white">
