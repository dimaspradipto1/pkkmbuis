...
@section('content')
    <div class="pagetitle d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <div>
            <h1 class="h4 fw-bold text-dark mb-1">Evaluasi Sistem Pendidikan Tinggi di Indonesia</h1>
            <nav>
                <ol class="breadcrumb mb-0 extra-small">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item">Evaluasi</li>
                    <li class="breadcrumb-item active">Sistem Pendidikan Tinggi di Indonesia</li>
                </ol>
            </nav>
        </div>
        <div class="d-flex gap-2">
            ...
            @endif
            <a href="{{ route('evaluasi.export', 6) }}" class="btn btn-success btn-sm shadow-sm rounded-pill px-3 py-2">
                <i class="bi bi-file-earmark-excel me-1"></i> Export Excel
            </a>
            <a href="{{ route('evaluasisistempendidikantinggidiindonesia.create') }}" class="btn btn-primary btn-sm shadow-sm rounded-pill px-3 py-2">
        ...
        $(document).ready(function() {
            ...
            $('#btn-bulk-delete').click(function() {
                ...
                const doDelete = function() {
                    const form = $('<form>', {
                        action: "{{ route('evaluasisistempendidikantinggidiindonesia.bulk-delete') }}",
                        method: 'POST'
                    });
                    form.append('@csrf');
