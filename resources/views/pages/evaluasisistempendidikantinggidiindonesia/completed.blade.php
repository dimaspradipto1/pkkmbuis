...
<div class="pagetitle">
    <h1>Evaluasi Sistem Pendidikan Tinggi di Indonesia</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="eval-completed-card">
            ...
            <div class="eval-completed-body">
                ...
                <p class="eval-completed-subtitle">
                    Anda hanya dapat mengisi formulir evaluasi ini satu kali. Tanggapan Anda untuk <strong>Sistem Pendidikan Tinggi di Indonesia</strong> telah berhasil disimpan dalam sistem.
                </p>
                <div class="eval-completed-actions">
                    ...
                    @if(Auth::user()->role != 'mahasiswa')
                        <a href="{{ route('evaluasisistempendidikantinggidiindonesia.show', $evaluasi->id) }}" class="btn-eval-primary">
