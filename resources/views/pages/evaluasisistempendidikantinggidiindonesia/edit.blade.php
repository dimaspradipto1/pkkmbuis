...
<div class="pagetitle">
    <h1>Edit Evaluasi Sistem Pendidikan Tinggi di Indonesia</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasisistempendidikantinggidiindonesia.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
