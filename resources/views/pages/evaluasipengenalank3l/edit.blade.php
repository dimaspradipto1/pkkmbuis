...
<div class="pagetitle">
    <h1>Edit Evaluasi Pengenalan Keselamatan, Kesehatan Kerja dan Lingkungan (K3L)</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasipengenalank3l.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
