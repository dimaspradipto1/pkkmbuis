...
<div class="pagetitle">
    <h1>Detail Evaluasi Pengenalan Keselamatan, Kesehatan Kerja dan Lingkungan (K3L)</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        ...
        <div class="eval-header-card">
            DETAIL EVALUASI PENGENALAN KESELAMATAN, KESEHATAN KERJA DAN LINGKUNGAN (K3L)
        </div>
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasipengenalank3l.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            <div>
                @if(Auth::user()->role != 'mahasiswa')
                    <a href="{{ route('evaluasipengenalank3l.edit', $evaluasi->id) }}" class="btn btn-primary px-4 me-2">
