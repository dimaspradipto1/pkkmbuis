...
<div class="pagetitle">
    <h1>Evaluasi Pengenalan Keselamatan, Kesehatan Kerja dan Lingkungan (K3L)</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="eval-completed-card">
            ...
            <div class="eval-completed-body">
                ...
                <p class="eval-completed-subtitle">
                    Anda hanya dapat mengisi formulir evaluasi ini satu kali. Tanggapan Anda untuk <strong>Pengenalan Keselamatan, Kesehatan Kerja dan Lingkungan (K3L)</strong> telah berhasil disimpan dalam sistem.
                </p>
                <div class="eval-completed-actions">
                    ...
                    @if(Auth::user()->role != 'mahasiswa')
                        <a href="{{ route('evaluasipengenalank3l.show', $evaluasi->id) }}" class="btn-eval-primary">
