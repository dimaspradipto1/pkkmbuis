...
@section('content')
    <div class="pagetitle">
        <h1>Soal Post Test Hari III</h1>
        <nav><ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">Soal Post Test Hari III</li>
        </ol></nav>
    </div>
    <section class="section">
        <div class="row"><div class="col-lg-12">
            @if (Auth::user()->role != 'mahasiswa')
                @php
                    $posttest_is_active = \App\Models\PostTestSetting::isActive(3);
                @endphp
                <div class="alert alert-light border border-warning shadow-sm mb-3 rounded-3 p-3">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            <strong class="text-dark"><i class="bi bi-shield-lock-fill text-warning me-1 fs-5"></i> Status Akses Sesi Post Test Hari III (Modul 3):</strong>
                        ...
                        <form action="{{ route('modulposttest.toggle-active', 3) }}" method="POST" class="d-inline m-0">
                            @csrf
            ...
            <div class="card"><div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title">List Soal Post Test Hari III</h5>
                            @if (Auth::user()->role != 'mahasiswa')
                                <div class="d-flex gap-2">
                                    <a href="{{ route('soalposttestketiga.export') }}" class="btn btn-outline-success btn-sm rounded shadow-sm px-3 text-success">
                                    ...
                                    <a href="{{ route('soalposttestketiga.create') }}" class="btn btn-primary btn-sm shadow-sm px-3 text-white">
                ...
                <div class="modal fade" id="importSoalModal" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                            ...
                            <form action="{{ route('soalposttestketiga.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body p-4">
                                    <div class="alert alert-info border-0 py-2 small mb-3 rounded-3">
                                        ...
                                        <br>
                                        <a href="{{ route('soalposttestketiga.template') }}" class="fw-bold text-primary"><i class="bi bi-cloud-download me-1"></i> Download Template</a>
                                    </div>
                                    <div class="mb-3">
