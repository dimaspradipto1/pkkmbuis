        ...
        <div class="eval-completed-card">
            ...
            <div class="eval-completed-body">
                ...
                <p class="eval-completed-subtitle">
                    Anda hanya dapat mengisi formulir evaluasi ini satu kali. Tanggapan Anda untuk <strong>IKA UIS</strong> telah berhasil disimpan dalam sistem.
                </p>
                <div class="eval-completed-actions">
                    ...
                    @if(Auth::user()->role != 'mahasiswa')
                        <a href="{{ route('evaluasiikauis.show', $evaluasi->id) }}" class="btn-eval-primary">
