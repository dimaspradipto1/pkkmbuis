...
<div class="pagetitle">
    <h1>Evaluasi Pelayanan Sistem Administrasi Keuangan</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="eval-completed-card">
            ...
            <div class="eval-completed-body">
                ...
                <p class="eval-completed-subtitle">
                    Anda hanya dapat mengisi formulir evaluasi ini satu kali. Tanggapan Anda untuk <strong>Pelayanan sistem administrasi keuangan</strong> telah berhasil disimpan dalam sistem.
                </p>
                <div class="eval-completed-actions">
                    ...
                    @if(Auth::user()->role != 'mahasiswa')
                        <a href="{{ route('evaluasipelayanansistemadministrasikeuangan.show', $evaluasi->id) }}" class="btn-eval-primary">
