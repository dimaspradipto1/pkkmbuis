...
<div class="pagetitle">
    <h1>Isi Evaluasi Pelayanan Sistem Administrasi Keuangan</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('evaluasipelayanansistemadministrasikeuangan.index') }}">Evaluasi</a></li>
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasipelayanansistemadministrasikeuangan.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-top-card">
                ...
                <div class="eval-top-body">
                    <h2 class="eval-top-title">
                        ...
                        (Pelayanan sistem administrasi keuangan)
                    </h2>
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasipelayanansistemadministrasikeuangan.index') }}" class="btn btn-outline-secondary px-4 me-2">
                            Kembali
                        </a>
                    @endif
