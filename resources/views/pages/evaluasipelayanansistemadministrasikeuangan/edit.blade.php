...
<div class="pagetitle">
    <h1>Edit Evaluasi Pelayanan Sistem Administrasi Keuangan</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasipelayanansistemadministrasikeuangan.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
