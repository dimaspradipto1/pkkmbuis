...
@section('content')
    <div class="pagetitle d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <div>
            <h1 class="h4 fw-bold text-dark mb-1">Evaluasi FIKes (Fakultas Ilmu Kesehatan)</h1>
            <nav>
                <ol class="breadcrumb mb-0 extra-small">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item">Evaluasi</li>
                    <li class="breadcrumb-item active">FIKes</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('evaluasifikes.create') }}" class="btn btn-primary btn-sm shadow-sm rounded-pill px-3 py-2">
