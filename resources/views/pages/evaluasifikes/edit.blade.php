...
<div class="pagetitle">
    <h1>Edit Evaluasi FIKes (Fakultas Ilmu Kesehatan)</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasifikes.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
            ...
            <div class="eval-action-bar">
                <div>
                    <a href="{{ route('evaluasifikes.index') }}" class="btn btn-outline-secondary px-4 me-2">Batal</a>
