...
<div class="pagetitle">
    <h1>Detail Evaluasi Kewirausahaan</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasikewirausahaan.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            <div>
                @if(Auth::user()->role != 'mahasiswa')
                    <a href="{{ route('evaluasikewirausahaan.edit', $evaluasi->id) }}" class="btn btn-primary px-4 me-2">
