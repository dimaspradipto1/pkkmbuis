...
<div class="pagetitle">
    <h1>Isi Evaluasi Kewirausahaan</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('evaluasikewirausahaan.index') }}">Evaluasi</a></li>
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasikewirausahaan.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasikewirausahaan.index') }}" class="btn btn-outline-secondary px-4 me-2">
                            Kembali
                        </a>
                    @endif
