...
@section('content')
    <div class="pagetitle">
        <h1>Edit Observasi Acara Feb</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('observasiacarafeb.index') }}">Observasi Acara Feb</a></li>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Observasi Acara Feb</h5>

                        <form action="{{ route('observasiacarafeb.update', $observasiAcaraFeb->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="waktu_runddown" id="waktu_runddown" class="form-control" value="{{ old('waktu_runddown', $observasiAcaraFeb->waktu_runddown) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="waktu_realisasi" id="waktu_realisasi" class="form-control" value="{{ old('waktu_realisasi', $observasiAcaraFeb->waktu_realisasi) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="kegiatan" id="kegiatan" class="form-control" rows="3" required>{{ old('kegiatan', $observasiAcaraFeb->kegiatan) }}</textarea>
                                </div>
                            </div>
                            ...
                            @php
                                ...
                                if (!$aspekItems) {
                                    $aspekItems = collect(explode("\n", (string) $observasiAcaraFeb->aspek_observasi))
                                ...
                                <div class="col-sm-10 d-flex align-items-center">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <div class="form-check form-check-inline me-4">
                                            <input class="form-check-input" type="radio" name="skala" id="skala_{{ $i }}" value="{{ $i }}" {{ old('skala', $observasiAcaraFeb->skala) == $i ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="catatan" id="catatan" class="form-control" rows="3">{{ old('catatan', $observasiAcaraFeb->catatan) }}</textarea>
                                </div>
                            </div>
                            ...
                            @php
                                ...
                                if (!$linkItems) {
                                    $linkItems = collect(explode("\n", (string) $observasiAcaraFeb->link_dokumen))
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a href="{{ route('observasiacarafeb.index') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
