...
@section('content')
    <div class="pagetitle">
        <h1>Soal Pretest Hari II</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item">Soal Pretest Hari II</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title">List Soal Pretest Hari II</h5>
                            @if (Auth::user()->role != 'mahasiswa')
                                <div class="d-flex gap-2">
                                    <a href="{{ route('soalpretestkedua.export') }}" class="btn btn-outline-success btn-sm rounded shadow-sm px-3 text-success">
                                    ...
                                    <a href="{{ route('soalpretestkedua.create') }}" class="btn btn-primary btn-sm shadow-sm px-3 text-white">
                ...
                <div class="modal fade" id="importSoalModal" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                            ...
                            <form action="{{ route('soalpretestkedua.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body p-4">
                                    <div class="alert alert-info border-0 py-2 small mb-3 rounded-3">
                                        ...
                                        <br>
                                        <a href="{{ route('soalpretestkedua.template') }}" class="fw-bold text-primary"><i class="bi bi-cloud-download me-1"></i> Download Template</a>
                                    </div>
                                    <div class="mb-3">
