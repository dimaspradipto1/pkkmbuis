                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                @if (Auth::user()->role != 'mahasiswa')
                                    <button type="button" class="btn btn-outline-dark" onclick="showSessionQR('Hadir Pagi (Hari I)', 'ABSEN_1_PAGI')">
                                        <i class="bi bi-qr-code me-1"></i> QR Pagi
                                    </button>
                                    <button type="button" class="btn btn-outline-dark" onclick="showSessionQR('Hadir Sore (Hari I)', 'ABSEN_1_SORE')">
...
@push('scripts')
    ...
    <script>
        ...
        // Function for Session QR (Admin showing to Students)
        ...
        // Function for User QR (Existing functionality)
