        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        @php
                            $sPagi = \App\Models\AbsenSetting::where('session_code', 'ABSEN_1_PAGI')->first();
                            $sSore = \App\Models\AbsenSetting::where('session_code', 'ABSEN_1_SORE')->first();
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                @if (Auth::user()->role != 'mahasiswa')
                                    @if ($isVisible)
                                        @if ($isActive)
                                            <button type="button" class="btn btn-outline-dark fw-bold" onclick="showAttendanceQR(1)">
                                    ...
                                    <a href="{{ route('absenpertama.export') }}" class="btn btn-success text-white">
        ...
        $(document).ready(function() {
            ...
            $('#btn-bulk-delete').click(function() {
                ...
                const doDelete = function() {
                    const form = $('<form>', {
                        action: "{{ route('absenpertama.bulk-delete') }}",
                        method: 'POST'
                    });
                    form.append('@csrf');
