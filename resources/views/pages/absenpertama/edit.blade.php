                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('absenpertama.update', $absenPertama->id) }}" method="POST"
                            ...
                            <div class="row mb-3" id="container_catatan" style="display: none;">
                                <label for="catatan" class="col-sm-3 col-form-label text-nowrap">Catatan & Bukti <span
                                        class="text-muted small">(Opsional)</span></label>
                                <div class="col-sm-9">
                                    <textarea name="catatan" id="catatan" class="form-control mb-3" rows="3"
                                        placeholder="Masukkan alasan / catatan (Izin / Tidak Hadir)...">{{ old('catatan', $absenPertama->catatan ?? '') }}</textarea>
                                    <label for="bukti_izin" class="form-label fw-semibold text-secondary small">Upload
                                        Bukti (PNG, JPG, JPEG, WEBP)</label>
