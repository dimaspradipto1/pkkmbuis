                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="btn-group w-100" role="group">
                                ...
                                <label class="btn btn-outline-success" for="pagi"><i class="bi bi-sun me-1"></i> Waktu Datang</label>

                                <input type="radio" class="btn-check" name="sesi_scan" id="sore" value="hadir_sore">
                                <label class="btn btn-outline-night" for="sore"><i class="bi bi-moon-stars me-1"></i> Waktu Pulang</label>
                            </div>
                        </div>
                        @else
