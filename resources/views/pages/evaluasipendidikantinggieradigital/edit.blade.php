...
<div class="pagetitle">
    <h1>Edit Evaluasi Pendidikan Tinggi di Era Digital dan Revolusi Industri</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasipendidikantinggieradigital.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
