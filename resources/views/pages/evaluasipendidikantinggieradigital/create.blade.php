...
<div class="pagetitle">
    <h1>Isi Evaluasi Pendidikan Tinggi di Era Digital dan Revolusi Industri</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('evaluasipendidikantinggieradigital.index') }}">Evaluasi</a></li>
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasipendidikantinggieradigital.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-top-card">
                ...
                <div class="eval-top-body">
                    <h2 class="eval-top-title">
                        ...
                        (Pendidikan Tinggi di Era Digital dan Revolusi Industri)
                    </h2>
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasipendidikantinggieradigital.index') }}" class="btn btn-outline-secondary px-4 me-2">
                            Kembali
                        </a>
                    @endif
