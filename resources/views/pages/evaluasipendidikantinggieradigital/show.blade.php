...
<div class="pagetitle">
    <h1>Detail Evaluasi Pendidikan Tinggi di Era Digital dan Revolusi Industri</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        ...
        <div class="eval-header-card">
            DETAIL EVALUASI PENDIDIKAN TINGGI DI ERA DIGITAL DAN REVOLUSI INDUSTRI
        </div>
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasipendidikantinggieradigital.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            <div>
                @if(Auth::user()->role != 'mahasiswa')
                    <a href="{{ route('evaluasipendidikantinggieradigital.edit', $evaluasi->id) }}" class="btn btn-primary px-4 me-2">
