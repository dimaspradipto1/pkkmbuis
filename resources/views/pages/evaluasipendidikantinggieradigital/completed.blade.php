...
<div class="pagetitle">
    <h1>Evaluasi Pendidikan Tinggi di Era Digital dan Revolusi Industri</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="eval-completed-card">
            ...
            <div class="eval-completed-body">
                ...
                <p class="eval-completed-subtitle">
                    Anda hanya dapat mengisi formulir evaluasi ini satu kali. Tanggapan Anda untuk <strong>Pendidikan Tinggi di Era Digital dan Revolusi Industri</strong> telah berhasil disimpan dalam sistem.
                </p>
                <div class="eval-completed-actions">
                    ...
                    @if(Auth::user()->role != 'mahasiswa')
                        <a href="{{ route('evaluasipendidikantinggieradigital.show', $evaluasi->id) }}" class="btn-eval-primary">
