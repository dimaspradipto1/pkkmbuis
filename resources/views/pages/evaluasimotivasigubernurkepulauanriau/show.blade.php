...
<div class="pagetitle">
    <h1>Detail Evaluasi Motivasi Gubernur Kepulauan Riau</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        <div class="eval-header-card">DETAIL EVALUASI MOTIVASI GUBERNUR KEPULAUAN RIAU</div>
        ...
        <div class="eval-card">
            ...
            <div class="p-3 bg-light rounded border eval-text-break">{{ $evaluasi->saran_dan_masukan ?: '-' }}</div>
        </div>

        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasimotivasigubernurkepulauanriau.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            @if(Auth::user()->role != 'mahasiswa')
                <a href="{{ route('evaluasimotivasigubernurkepulauanriau.edit', $evaluasi->id) }}" class="btn btn-primary px-4">
