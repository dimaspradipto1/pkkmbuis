...
<div class="pagetitle">
    <h1>Edit Evaluasi Motivasi Gubernur Kepulauan Riau</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasimotivasigubernurkepulauanriau.update', $evaluasi->id) }}" method="POST" id="evalForm">
            @csrf
            @method('PUT')
            ...
            <div class="eval-action-bar">
                <div>
                    <a href="{{ route('evaluasimotivasigubernurkepulauanriau.index') }}" class="btn btn-outline-secondary px-4 me-2">Batal</a>
                    <button type="submit" class="btn btn-primary px-4">Update Evaluasi</button>
                </div>
            </div>
        </form>
    </div>
