...
<style>
    ...
    .eval-header-card { background-color: #356B3A !important; color: #ffffff; border-radius: 10px 10px 0 0; padding: 16px 24px; font-weight: 700; font-size: 1.1rem; letter-spacing: 0.5px; }
    ...
    .eval-radio-col input[type="radio"] { width: 20px; height: 20px; cursor: pointer; accent-color: #356B3A; margin: 0; }
    ...
    .eval-input-line:focus { outline: none; border-bottom-color: #356B3A; box-shadow: none; }
    ...
    .eval-top-bar { height: 10px; background-color: #356B3A; }
...
<div class="pagetitle">
    <h1>Isi Evaluasi Motivasi Gubernur Kepulauan Riau</h1>
    <nav>
        <ol class="breadcrumb">
...
<div class="container-fluid py-3">
    <div class="eval-container">
        <form action="{{ route('evaluasimotivasigubernurkepulauanriau.store') }}" method="POST" id="evalForm">
            @csrf
            ...
            <div class="eval-top-card">
                ...
                <div class="eval-top-body">
                    <h2 class="eval-top-title">
                        ...
                        (Motivasi Gubernur Kepulauan Riau)
                    </h2>
            ...
            <!-- Saran & Masukan Card -->
            <div class="eval-card">
                <div class="eval-question-title">Berikan saran dan masukan terhadap pemateri</div>
                <div class="mt-3">
                    ...
                    @error('saran_dan_masukan')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
            </div>
            ...
            <div class="eval-action-bar">
                <div>
                    ...
                    @else
                        <a href="{{ route('evaluasimotivasigubernurkepulauanriau.index') }}" class="btn btn-outline-secondary px-4 me-2">Kembali</a>
                    @endif
