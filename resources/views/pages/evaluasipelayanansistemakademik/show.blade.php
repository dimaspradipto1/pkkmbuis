...
<div class="pagetitle">
    <h1>Detail Evaluasi Pelayanan Sistem Akademik</h1>
    <nav>
        <ol class="breadcrumb">
...
<section class="section">
    <div class="eval-container">
        ...
        <div class="eval-header-card">
            DETAIL EVALUASI PELAYANAN SISTEM AKADEMIK
        </div>
        ...
        <div class="d-flex justify-content-between my-4">
            <a href="{{ route('evaluasipelayanansistemakademik.index') }}" class="btn btn-outline-secondary px-4">
                <i class="bi bi-arrow-left me-1"></i> Kembali
            </a>
            <div>
                @if(Auth::user()->role != 'mahasiswa')
                    <a href="{{ route('evaluasipelayanansistemakademik.edit', $evaluasi->id) }}" class="btn btn-primary px-4 me-2">
