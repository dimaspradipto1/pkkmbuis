...
@section('content')
    <div class="pagetitle">
        <h1>Data Kedisiplinan Hari II</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item">Kedisiplinan Hari II</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title">List Kedisiplinan Hari II</h5>
                            @if (Auth::user()->role != 'mahasiswa')
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('kedisiplinankedua.export') }}" class="btn btn-success text-white">
                ...
                @include('partials.kedisiplinan-notes', ['category' => 'kedisiplinankedua'])
    ...
    <div class="modal fade" id="bulkEditModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ route('kedisiplinankedua.bulk-update') }}" method="POST" id="bulk-edit-form">
                @csrf
...
@push('scripts')
    <script>
        $(document).ready(function() {
            const table = $('#kedisiplinankedua-table');
