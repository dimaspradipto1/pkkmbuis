...
return new class extends Migration
{
    ...
    {
        Schema::create('evaluasi_fikes', function (Blueprint $table) {
            $table->id();
            ...
            // Saran dan Masukan kepada Pemateri
            $table->text('saran_dekan')->nullable();
            $table->text('saran_wakil_dekan_1')->nullable();
            $table->text('saran_wakil_dekan_2')->nullable();
            $table->text('saran_prodi_s1_kesling')->nullable();
            $table->text('saran_prodi_s1_k3')->nullable();
            $table->text('saran_prodi_s2_kesmas')->nullable();
            $table->text('saran_hiv')->nullable();
            $table->text('saran_alumni_fikes')->nullable();
    ...
    {
        Schema::dropIfExists('evaluasi_fikes');
    }
};
