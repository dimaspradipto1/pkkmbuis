...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $items = [
            ...
            ['nomor' => 3, 'nama' => '3. Pelayanan sistem Akademik', 'route_name' => 'evaluasipelayanansistemakademik.index', 'is_active' => true],
            ['nomor' => 4, 'nama' => '4. Pelayanan sistem administrasi keuangan', 'route_name' => 'evaluasipelayanansistemadministrasikeuangan.index', 'is_active' => true],
            ['nomor' => 5, 'nama' => '5. Kehidupan Berbangsa, Bernegara dan pembinaan kesadaran bela negara', 'route_name' => 'evaluasikehidupanberbangsabelanegara.index', 'is_active' => true],
            ['nomor' => 6, 'nama' => '6. Sistem Pendidikan Tinggi di Indonesia', 'route_name' => 'evaluasisistempendidikantinggidiindonesia.index', 'is_active' => true],
            ['nomor' => 7, 'nama' => '7. Pendidikan Tinggi di Era Digital dan Revolusi Industri', 'route_name' => 'evaluasipendidikantinggieradigital.index', 'is_active' => true],
