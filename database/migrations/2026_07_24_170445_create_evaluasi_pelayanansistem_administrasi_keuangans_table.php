...
return new class extends Migration
{
    ...
    {
        Schema::create('evaluasi_pelayanansistem_administrasi_keuangans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evaluasi_pelayanansistem_administrasi_keuangans');
    }
};
