...
return new class extends Migration
{
    ...
    {
        Schema::create('evaluasi_fsts', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('saran_pii_batam')->nullable();
            $table->text('saran_ika_fst')->nullable();
            $table->text('saran_prodi_teknik_industri')->nullable();
            $table->text('saran_prodi_if_si')->nullable();
            $table->text('saran_prodi_logistik_perkapalan')->nullable();
            $table->text('saran_laboratorium')->nullable();
            $table->text('saran_hima_fst')->nullable();
    ...
    {
        Schema::dropIfExists('evaluasi_fsts');
    }
};
